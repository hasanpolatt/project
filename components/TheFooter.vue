<template>
  <footer class="footer-container section">
    <div
        ...
        <div class="is-flex is-align-items-center footer-container-subs-items">
          ...
          <script>
            window.CustomSubstackWidget = {
              substackUrl: 'hasan@hasan.com',
              placeholder: 'hasan@hasan.com',
              theme: 'custom',
              colors: {
                primary: '#FF7AC3',
                input: '#FFFFFF',
      ...
      <div class="footer-container-info is-flex is-flex-direction-column">
        <h4 class="subtitle is-5">NFTTopia</h4>
        <div>
          <ul>
            <li
    ...
    <img src="/" class="left-blurred-image" />
  </footer>
</template>
...
const socials = [
  {
    name: 'Twitter',
    url: 'https://twitter.com/immortalasgod',
    icon: 'twitter',
  },
  {
    name: 'Discord',
  ...
  {
    name: 'Medium',
    url: 'https://medium.com/@gwynbleiddww',
    icon: 'medium',
  },
  {
    name: 'Youtube',
