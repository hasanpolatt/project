<template>
  <section>
    ...
    <h1 class="subtitle">
      NFTTopia is going to be carbon-negative gallery, by default
    </h1>
    <p>
    ...
    <br />
    <h1 class="title is-4">Carbon Neutral Mission</h1>
    <p>
      The mission of us yyis to flow collectors' resources to
      ...
      <i
        >"high-quality pro-climate projects via the purchase of carbon offsets
        credits"</i
      >. <br /><br />
    ...
    <br />
    <h1 class="title is-4">Humble actions</h1>
    <p>
      We are aware that just by purchasing Carbon Offsets we won't solve the
      issue, but
      <b
        >we can be small butterfly effect, and later jumpstart impactful actions
        to start a forestation movement on bigger scale</b
    ...
    <p>
      ...
      <b
        ><a
          ...
          Terraformation of Planet Earth</a
        ></b
      >
    ...
    <br />
    <h1 class="title is-4">We are not only one and that's great</h1>
    <p>
      We are really aware that movement is just about to begin when news outlets
      started heating discussion and
      <b
        ><a href="https://twitter.com/search?q=%23CleanNFT&src=typeahead_click">
          #cleanNFT movement</a
        ></b
      >
    ...
    <p>
      ...
      <b
        ><a
          href=""
          >we've already bought Carbon Credits</a
        ></b
      >
      ...
      <b
        ...
        <u
          ...
          >
          and <a href="https://discord.gg/">Discord</a></u
        ></b
      >
    </p>
    <br />
    <h1 class="title is-4">Reading list</h1>
    <p>
      Whenever you want to learn more about cleanNFTs,
      <u
        ><a href=""
          >we left some material in our issues.</a
        ></u
      >
    </p>
  </section>
